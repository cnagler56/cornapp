import { getBeanYields, fetchBeanYield } from './Slices/BeanSlice';
...
const Soybeans = () => {
  ...
  const yielddata = useSelector(getBeanYields);
  ...
  // Dispatch fetchBeanYield on component mount
  useEffect(() => {
    dispatch(fetchBeanYield());
  }, [dispatch]);
    ...
    <>
      <main className="container">
        ...
        <section className="sideb">
          ...
          <div className="guess">
            <GuessBox yield={beans} grain={grain} />
          </div>
        </section>
      </main>
    </>
